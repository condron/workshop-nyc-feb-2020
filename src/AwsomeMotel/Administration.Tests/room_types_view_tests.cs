...
namespace Administration.Tests
{
    public class room_types_view_tests
    {
        ...
        {
            //given 
            var rt2 = new RoomTypeAdded(Guid.NewGuid(), "2Queen","sample description");
            var rt1 = new RoomTypeAdded(Guid.NewGuid(), "1King" ,"sample description");
            var rt3 = new RoomTypeAdded(Guid.NewGuid(), "3Econ" ,"sample description");
            //when
